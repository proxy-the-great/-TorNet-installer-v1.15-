...
print("") #leaving empty spaces for more order :)
print('''\033[93m\033[1mWARNING! THIS SCRIPT WILL NOT EXECUTE <--BREAK-SYSTEM-PACKAGES>  
(This is the alternate version of the script, if you encounter errors use the og)''')
print("") #leaving empty spaces for more order :)
...
cmd = "sudo apt install tor && sudo apt install python3-pip && sudo pip install tornet && sudo systemctl start tor && tornet --auto-fix  && clear && sudo tornet --interval 15 --count 0"
